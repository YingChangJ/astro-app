...
import { Line, Circle } from "./SVGComponents.jsx";
import { Planet, Cusps } from "./Chart-related.jsx";
export default function SVG({ planetState, cusps }) {
  const svgWidth = 404;
  ...
  // const smaller = Math.min(widthInner, heightInner);
  return (
    <svg
      viewBox={
